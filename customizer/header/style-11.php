...
$priority = Billey_Customize::instance()->group_field_header_button( $header_style, $prefix, $priority, $section, array(
	'style'   => 'flat',
	'rounded' => '4px',
	'classes' => 'header-button-bg-gradient-01',
) );
...
Billey_Kirki::add_field( 'theme', array(
	...
	'description' => esc_html__( 'Controls the background of header.', 'billey' ),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => array(
...
Billey_Kirki::add_field( 'theme', array(
	...
	'output'          => Billey_Header::instance()->get_button_kirki_output( $header_style, 'dark', false ),
...
Billey_Kirki::add_field( 'theme', array(
	...
	'output'          => Billey_Header::instance()->get_button_kirki_output( $header_style, 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Billey_Kirki::add_field( 'theme', array(
	...
	'output'          => Billey_Header::instance()->get_button_kirki_output( $header_style, 'light', false ),
	'active_callback' => array(
		array(
...
Billey_Kirki::add_field( 'theme', array(
	...
	'output'          => Billey_Header::instance()->get_button_kirki_output( $header_style, 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
