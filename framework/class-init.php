...
class Billey_Init {
	...
	public function initialize() {
		...
		if ( ! function_exists( '_wp_render_title_tag' ) ) {
			add_action( 'wp_head', array( $this, 'billey_render_title' ) );
		}
	}

	function billey_render_title() {
		?>
	...
	public function setup() {
		 ...
		 */
		load_theme_textdomain( 'billey', BILLEY_THEME_DIR . '/languages' );
	...
	function core_info( $info ) {
		...
		$info['desc']    = esc_html__( 'Thank you for using our theme, please reward it a full five-star &#9733;&#9733;&#9733;&#9733;&#9733; rating.', 'billey' );
