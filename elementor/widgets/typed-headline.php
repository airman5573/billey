...
class Widget_Typed_Headline extends Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_script( 'typed', BILLEY_THEME_URI . '/assets/libs/typed/typed.min.js', array(), null, true );

		wp_register_script( 'billey-widget-typed-headline', BILLEY_ELEMENTOR_URI . '/assets/js/widgets/widget-typed-headline.js', array(
			'elementor-frontend',
			'typed',
		), null, true );
	}
	...
	public function get_title() {
		return esc_html__( 'Typed Headline', 'billey' );
	}
	...
	public function get_script_depends() {
		return [ 'billey-widget-typed-headline' ];
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'before_text', [
			'label'       => esc_html__( 'Before Text', 'billey' ),
			...
			'default'     => esc_html__( 'This page is', 'billey' ),
			'placeholder' => esc_html__( 'Enter your headline', 'billey' ),
			'label_block' => true,
			'separator'   => 'before',
		] );
		...
		$this->add_control( 'text', [
			...
			'placeholder'        => esc_html__( 'Enter each word in a separate line', 'billey' ),
			'separator'          => 'none',
			'default'            => "Better\nBigger\nFaster",
		...
		$this->add_control( 'after_text', [
			...
			'placeholder' => __( 'Enter your headline', 'billey' ),
			'label_block' => true,
			'separator'   => 'none',
		] );
	...
	private function add_headline_style_section() {
		$this->start_controls_section( 'headline_style_section', [
			'label' => esc_html__( 'Headline', 'billey' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'selector' => '{{WRAPPER}} .billey-headline',
		] );
		...
		$this->add_control( 'blend_mode', [
			...
			'selectors' => [
				'{{WRAPPER}} .billey-headline' => 'mix-blend-mode: {{VALUE}}',
			],
			'separator' => 'none',
		] );
		...
		$this->add_control( 'animated_text_heading', [
			'label'     => esc_html__( 'Animated Text', 'billey' ),
	...
	protected function render() {
		...
		$this->add_render_attribute( 'headline', 'class', 'billey-headline' );
		?>
