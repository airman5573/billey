...
class Widget_Team_Member_Carousel extends Static_Carousel {
	...
	public function get_title() {
		return esc_html__( 'Team Member Carousel', 'billey' );
	}
	...
	protected function add_repeater_controls( Repeater $repeater ) {
		...
		$repeater->add_control( 'socials', [
			'label'       => esc_html__( 'Socials', 'billey' ),
			'description' => esc_html__( 'One social per line. Icon class & url separator with |. For eg: fab fa-facebook|https://facebook.com', 'billey' ),
			'type'        => Controls_Manager::TEXTAREA,
		] );
	}
	...
	protected function print_slide() {
		...
		$current_key   = $this->get_current_slide_key();
	...
	protected function before_render_slider_wrapper() {
		$this->add_render_attribute( $this->get_slider_wrapper_key(), 'class', 'tm-team-member-carousel' );
	}
}
